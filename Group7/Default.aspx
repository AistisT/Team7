<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Group7._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="searchPanel" runat="server" DefaultButton="searchButton1" CssClass="row">
        <div class="col-sm-6">
            ...
            <p class="text-muted">Job title, keywords, company</p>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            ...
            <asp:ListView ID="searchListView" runat="server" OnPagePropertiesChanged="searchListPropertiesChanged">
                <AlternatingItemTemplate>
                    <a href="<%# ResolveClientUrl("~/VacancyOutput.aspx?id=" + Eval("AdvertID").ToString()) %>" class="list-group-item">
