<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntryForm.aspx.cs" Inherits="Group7.About" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Various  javascripts used within entry form page similar to scripts used on edit form page, edit page contains more comments-->
    <script>   
        // getting todays date for datepicker and validator
        var today = new Date();
        ...
        $(document).ready(function() {
            $('#calendarPicker').datepicker({
                format: "dd/mm/yyyy",
                startDate: today, // causes few keyboard navigation bugs ( can move just forward and not backwards with keyboard )
                weekStart: 1,
                autoclose: true,
                todayHighlight: true
            });
            ...
            // calls validation function on enter key press while focused on a any textbox in a page
            ...
            $(document).on('click', '.dropdown-menu li a', function() {
                ...
                $("#formValidator").data('bootstrapValidator').revalidateField( $(this).parent().parent().parent().parent().find('input[type="text"]'));  
            });
        });
    </script>
</asp:Content>
